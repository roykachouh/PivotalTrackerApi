...
public class ProjectMembershipTest {
	...
	public void setup() {
		...
		projectMembership = new ProjectMembershipBuilder()
	...
	public void testPersonToJson() throws IOException {
		...
		Map<String, Object> result =
				new ObjectMapper().readValue(projectMembershipJSON, new TypeReference<HashMap<String, Object>>() {});
		...
		assertThat(result.get("will_receive_mention_notifications_or_emails")).isEqualTo(WILL_RECEIVE_MENTION_NOTIFICATIONS_OR_EMAILS);
	}

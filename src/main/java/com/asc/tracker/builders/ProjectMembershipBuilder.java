...
public class ProjectMembershipBuilder {
  ...
  public ProjectMembershipBuilder withWillReceiveMentionNotificationsOrEmails(Boolean
      willReceiveMentionNotificationsOrEmails) {
  ...
  public ProjectMembership createProjectMembership() {
    return new ProjectMembership(personId,
        projectId,
        role,
        projectColor,
        lastViewedAt,

...
public class StoryBuilder {
	...
	public Story createStory() {
		return new Story(projectId, name, description, storyType, currentState, estimate, acceptedAt, deadline, requestedById, ownerIds, taskIds, followerIds, commentIds, labelIds,integrationId, externalId, url);
	}
}